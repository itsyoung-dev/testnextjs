        ...
        <section className="h-[679px] spacing-default pt-32">
            <div className="flex flex-col items-center justify-between md:flex-row">
                <div className="flex-start flex-col h-[450px] md:h-[383px] max-w-[520px] md:pr-8">
                    <h5 className="text-[#5865F2] font-medium tracking-text-default leading-header pb-6 text-base">
                        Collaboration
                    </h5>
                    <h2 className="text-[40px] font-semibold text-primary-white pb-8 leading-text-default">
                        Collaborate with us through our memberships
                    </h2>
                    <p className="text-secondary-gray pb-8 pr-28 tracking-text-default leading-text-default text-base">
                    ...
                    <Link
                        href="/"
                        className="w-[164px] h-[44px] gap-3 flex items-center bg-primary-white rounded-md justify-end flex-shrink-0 text-primary-black font-medium text-sm"
                    >
                        Subscribe now{" "}
