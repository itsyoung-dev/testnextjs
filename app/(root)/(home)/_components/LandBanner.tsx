...
const LandBanner = () => {
    return (
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
            <div className="sm:top-[-20rem] overflow-hidden custom-bg-blob-parent z-[-10]">
                <div className="custom-bg-blob-child"></div>
            </div>
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                Creëer
                <span className="relative whitespace-nowrap text-primary-orange">
                    <svg
                        aria-hidden="true"
                        viewBox="0 0 418 42"
                        className="absolute left-0 top-2/3 h-[0.58em] w-full fill-primary-orange/40"
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
                Bouw je website zoals jij dat wilt, zonder gedoe. Of je nu kiest
                voor sjablonen of vanaf nul begint, we maken online bouwen
                gemakkelijk.
            </p>
            <div className="mt-10 flex justify-center gap-x-6">
                ...
                >
                    <svg
                        aria-hidden="true"
                        className="h-3 w-3 flex-none fill-primary-orange group-active:fill-current"
                    >
                        <path d="m9.997 6.91-7.583 3.447A1 1 0 0 1 1 9.447V2.553a1 1 0 0 1 1.414-.91L9.997 5.09c.782.355.782 1.465 0 1.82Z"></path>
                    </svg>
                    <span className="ml-3">Bekijk demo</span>
                </a>
            </div>
            <div className="mt-36 lg:mt-44">
                <p className="font-display text-base text-slate-900">
                    Vertrouwd bij deze 6 bedrijven tot nu toe
                </p>
                <ul
                    role="list"
            ...
            <div className="custom-bg-bottom-parent">
                <div className="custom-bg-bottom-child"></div>
            </div>
        </div>
    );
};
